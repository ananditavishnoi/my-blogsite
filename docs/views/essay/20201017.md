...
Whereas, backend is the brain of the application. It is where the data is stored. The parts developed in the backend are indirectly accessed by users through a front-end application.
...
2. **CSS** (Cascading Style Sheet) controls the appearance of the webpage. It can be thought of as the makeup for the skin. 
...
Putting it in the simplest terms, a web server is where the contents of a website are stored, i.e. the storage facility can be thought of as the web server. It provides serving dynamic HTML content to any client requesting it. 
